 ...
 */
package com.convertium.stageone.core.models;
...
import com.convertium.stageone.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "convertium/components/helloworld");
